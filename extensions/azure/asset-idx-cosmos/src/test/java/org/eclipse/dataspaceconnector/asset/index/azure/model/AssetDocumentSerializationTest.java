...
package org.eclipse.dataspaceconnector.asset.index.azure.model;
...
class AssetDocumentSerializationTest {
    ...
    void testSerialization() {
        ...
        var document = new AssetDocument(asset, "test-process");
        ...
        assertThat(s).isNotNull()
                ...
                .contains("\"properties\":{\"foo\":\"bar\",\"hello\":\"world\"}");
    }
