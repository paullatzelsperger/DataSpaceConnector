...
public class CosmosAssetIndexExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        context.registerService(AssetIndex.class, new CosmosAssetIndex(container, configuration.getPartitionKey(), context.getTypeManager(), context.getService(RetryPolicy.class)));
